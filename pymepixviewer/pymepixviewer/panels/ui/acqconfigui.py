...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_time = QtWidgets.QLineEdit(self.groupBox)
        self.frame_time.setInputMask("")
        self.frame_time.setObjectName("frame_time")
        self.horizontalLayout_15.addWidget(self.frame_time)
        self.time_multi = QtWidgets.QComboBox(self.groupBox)
        ...
        self.time_multi.addItem("")
        self.horizontalLayout_15.addWidget(self.time_multi)
