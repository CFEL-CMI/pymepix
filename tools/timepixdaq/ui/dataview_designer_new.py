...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_7.addWidget(self.startAcq)
        ...
        self.timeValue = QtWidgets.QLineEdit(self.groupBox_3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Exposure Window"))
